...
#### 1.1 **Операционные Домены (Source Domains)**: 
...
#### 1.2 **Платформенные Домены (Platform Domains)**: 
...
#### 1.3 **Потребительские Домены (Consumption Domains)**: 
...
(Включает несколько под-доменов)  
