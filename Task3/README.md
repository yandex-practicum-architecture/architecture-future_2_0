...
#### Средства/инструментарий для построения:
...
|                       | AWS/Azure/GCP                  | Отсутствует            | Assess           | Облачные платформы. Предоставляют необходимую инфраструктуру для Data Platform.                                      |
...
#### Дорожная Карта Трансформации Данных "Будущее 2.0"
...
### 3. Обоснование этапов дорожной карты
